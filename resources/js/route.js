const patterns = {
    ...
    'finance.topups': () => '/finance/top-ups',
    'finance.topups.store': () => '/finance/top-ups',
    'finance.settings.update': () => '/finance/settings',
    'finance.players.show': (p) => `/finance/players/${p}`,
    'finance.transactions.update': (p) => `/finance/transactions/${p}`,
    'finance.games.charges.edit': (p) => `/finance/games/${p}/charges`,
    'finance.games.charges.update': (p) => `/finance/games/${p}/charges`,
