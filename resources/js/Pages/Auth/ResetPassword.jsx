...
export default function ResetPassword({ token, userId }) {
    ...
    const { data, setData, post, processing, errors } = useForm({ token, user_id: userId ?? '', password: '', password_confirmation: '' });
